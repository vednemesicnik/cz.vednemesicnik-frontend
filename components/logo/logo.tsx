  ...
  return (
    ...
    >
      ...
      <g clipPath="url(#_clip1)">
        ...
        <path d="M200,152L392,152L776,800L776,848L608,848L200,152Z" style={{ fill: palette.logo[0] }} />
        <path
      ...
      <defs>
        ...
        >
          <stop offset="0" style={{ stopColor: palette.logo[2], stopOpacity: 1 }} />
          <stop offset="0.52" style={{ stopColor: palette.logo[1], stopOpacity: 1 }} />
          <stop offset="1" style={{ stopColor: palette.logo[0], stopOpacity: 1 }} />
        </linearGradient>
      </defs>
    </svg>
  )
